...
risktype = "JCC" #["no_risk", "CC","JCC", "HJCC", "CVaR"] # "slack" "no_markets"["no_markets"] #

OS_folder = "OS_results_bid\\"
saving = true
...
if risktype == "CVaR"
@constraint(out_of_S_model, out_of_S_TCL_up_reserve_limit[f in F,t in T,s in S], data["FCRN_accept"][f,t,out_of_S[s]]*out_of_S_model[:p_c_FCRN][f,t] + out_of_S_model[:p_c_mFRR][f,t] + data["FCRD_accept"][f,t,out_of_S[s]]*out_of_S_model[:p_c_FCRD][f,t] + out_of_S_model[:p_c_FFR][f,t] <= data["D_base_TCL"][f,t,out_of_S[s]] + out_of_S_model[:q_TCL_up][f,t,s] + out_of_S_model[:slack_TCL_up][f,t,s]) # Limit on ancillary upward reserve bid
@constraint(out_of_S_model, out_of_S_TCL_down_reserve_limit[f in F,t in T,s in S], data["FCRN_accept"][f,t,out_of_S[s]]*out_of_S_model[:p_c_FCRN][f,t] <= data["Pmax_TCL"] - data["D_base_TCL"][f,t,out_of_S[s]] + out_of_S_model[:q_TCL_down][f,t,s] + out_of_S_model[:slack_TCL_down][f,t,s]) # Limit on ancillary upward reserve bid
@constraint(out_of_S_model, out_of_S_EV_up_reserve_limit[e in E,t in T,s in S], data["FCRN_accept"][e,t,out_of_S[s]]*out_of_S_model[:p_c_FCRN][e,t] + out_of_S_model[:p_c_mFRR][e,t] + data["FCRD_accept"][e,t,out_of_S[s]]*out_of_S_model[:p_c_FCRD][e,t] + out_of_S_model[:p_c_FFR][e,t] <= data["EV_con"][e,t,out_of_S[s]]*data["Pmax_ev"][e] + out_of_S_model[:q_EV_up][e,t,s] + out_of_S_model[:slack_EV_up][e,t,s]) # Limit on ancillary upward reserve bid
@constraint(out_of_S_model, out_of_S_EV_down_reserve_limit[e in E,t in T,s in S], data["FCRN_accept"][e,t,out_of_S[s]]*out_of_S_model[:p_c_FCRN][e,t] <= data["EV_con"][e,t,out_of_S[s]]*data["Pmax_ev"][e] + out_of_S_model[:q_EV_down][e,t,s] + out_of_S_model[:slack_EV_down][e,t,s]) # Limit on ancillary upward reserve bid
elseif risktype == "JCC"
@constraint(out_of_S_model, out_of_S_TCL_up_reserve_limit[f in F,t in T,s in S], data["FCRN_accept"][f,t,out_of_S[s]]*out_of_S_model[:p_c_FCRN][f,t] + out_of_S_model[:p_c_mFRR][f,t] + data["FCRD_accept"][f,t,out_of_S[s]]*out_of_S_model[:p_c_FCRD][f,t] + out_of_S_model[:p_c_FFR][f,t] <= (1 - out_of_S_model[:y][s])*data["D_base_TCL"][f,t,out_of_S[s]] + out_of_S_model[:y][s]*data["Pmax_TCL"] + out_of_S_model[:slack_TCL_up][f,t,s]) # Limit on ancillary upward reserve bid
@constraint(out_of_S_model, out_of_S_TCL_down_reserve_limit[f in F,t in T,s in S], data["FCRN_accept"][f,t,out_of_S[s]]*out_of_S_model[:p_c_FCRN][f,t] <= (1 - out_of_S_model[:y][s])*(data["Pmax_TCL"] - data["D_base_TCL"][f,t,out_of_S[s]]) + out_of_S_model[:y][s]*data["Pmax_TCL"] + out_of_S_model[:slack_TCL_down][f,t,s]) # Limit on ancillary upward reserve bid
@constraint(out_of_S_model, out_of_S_EV_up_reserve_limit[e in E,t in T,s in S], data["FCRN_accept"][e,t,out_of_S[s]]*out_of_S_model[:p_c_FCRN][e,t] + out_of_S_model[:p_c_mFRR][e,t] + data["FCRD_accept"][e,t,out_of_S[s]]*out_of_S_model[:p_c_FCRD][e,t] + out_of_S_model[:p_c_FFR][e,t] <= (1 - out_of_S_model[:y][s])*data["EV_con"][e,t,out_of_S[s]]*data["Pmax_ev"][e] + out_of_S_model[:y][s]*data["Pmax_ev"][e] + out_of_S_model[:slack_EV_up][e,t,s]) # Limit on ancillary upward reserve bid
@constraint(out_of_S_model, out_of_S_EV_down_reserve_limit[e in E,t in T,s in S], data["FCRN_accept"][e,t,out_of_S[s]]*out_of_S_model[:p_c_FCRN][e,t] <= (1 - out_of_S_model[:y][s])*data["EV_con"][e,t,out_of_S[s]]*data["Pmax_ev"][e] + out_of_S_model[:y][s]*data["Pmax_ev"][e] + out_of_S_model[:slack_EV_down][e,t,s]) # Limit on ancillary upward reserve bid  
...
results = load("OS_results_bid\\model_OS_260_JCC_results.jld2")
results["solve_time"]
#= OS
OS_name = "model_OS_$(inS_size)_"*risktype
out_of_S_results["OS_obj_s"] = OS_obj_s # save obj_s in results 
